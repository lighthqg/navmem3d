...
for e in g['edges']:draw.line([point(e['from_node']),point(e['to_node'])],fill=(75,170,210),width=2)
for n in nodes:
 x,y=point(n);draw.ellipse((x-3,y-3,x+3,y+3),fill=(255,185,35),outline=(0,0,0))
if route:
 sequence=route['node_sequence']
 for u,v in zip(sequence,sequence[1:]):draw.line([point(u),point(v)],fill=(70,220,255),width=4)
